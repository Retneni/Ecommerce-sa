...
insert  into `accountdetails`(`username`,`branch`,`email`,`address`,`mobile`,`amount`) values ('ramu','ameerpet','ramu@gmail.com','Ameerpet','9052016340',68000),('shiva','ameerpet','shiva@gmail.com','hyd','9875641230',35000),('moulali','Andhrabank','aa@gmail.com','hyd','09874561230',50000),('chotu','Andhrabank','aa@gmail.com','hyd','09874561230',6000);
...
insert  into `category`(`id`,`category`) values (1,'Sports'),(2,'Mobiles'),(3,'Laptops'),(4,'Electronics');
...
insert  into `reviews`(`username`,`productname`,`category`,`review`,`rating`) values ('chotu','Samsung J7','Mobiles','good','5');
...
insert  into `user`(`id`,`username`,`password`,`email`,`dob`,`gender`,`address`,`mobile`,`status`) values (4,'moulali','123','moulalicce225@gmail.com','2019-11-06','MALE','Hyderabad','09032101992','Activated'),(6,'chotu','123','chotu.1000projects@gmail.com','2019-11-19','MALE','Hyderabad','09032101992','Activated');
