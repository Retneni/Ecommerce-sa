...
from sentimentanalysis import model_predict,load_model
...
def user_rateact(productname,category,review,rating):
    ...
    senti=load_model(review)
    print("cccccccccccccccccc")
    print(senti)
    j = c.execute("insert into reviews(username,productname,category,review,rating,sentiment) values ('" +
                  username + "','" + productname + "','" + category + "','" + review + "','" + rating + "','" + senti + "')")
